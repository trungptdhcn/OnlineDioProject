...
public class HomeFeedSynAdapter extends AbstractThreadedSyncAdapter
{
                              ...
                              final ContentProviderClient provider, final SyncResult syncResult)
    {
        try
        {
            ...
            {
                homeModel.setAccount_id(Long.parseLong(account_id));
                ...
                batch.add(ContentProviderOperation
                        ...
                        .withValue(DbHelper.HOMEFEED_COL_ACCOUNT_ID, homeModel.account_id)
            ...
            Message message = HomeFragment.handler.obtainMessage();
            Bundle bundle = new Bundle();
            bundle.putString("ok", "Done");
